...
// Umbilical
extern Model* modelUmbilical;
extern Plugin* pluginInstance__Umbilical;
...
static void initStatic__Umbilical()
{
    Plugin* const p = new Plugin;
    pluginInstance__Umbilical = p;

    const StaticPluginLoader spl(p, "Umbilical");
    if (spl.ok())
    {
        p->addModel(modelUmbilical);
    }
}
